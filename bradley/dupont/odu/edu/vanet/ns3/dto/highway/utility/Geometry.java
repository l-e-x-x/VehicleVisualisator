...
public class Geometry {
    ...
    public static double zeroOut(double numToZero) {
    ...
    public static void findIntersection(double theta1, double x1, double y1, double theta2, double x2, double y2, double results[]) {
        ...
        double slope1 = zeroOut(Math.tan(angle1));
        double intercept1 = zeroOut(y1 - slope1 * x1);
        double slope2 = zeroOut(Math.tan(theta2));
    ...
    public static double angleToPoint(double startX, double startY, double endX, double endY) {
        ...
        if (numerator == 0.0) {
            ...
            if (denominator == 0.0) {
                ...
                double tempVal = Math.atan(numerator / denominator);
                if (numerator > 0) {
                    if (denominator > 0) {
    ...
    public static double directDistance(double x1, double y1, double x2, double y2) {
        double xDist = (x1 - x2);
        double yDist = (y1 - y2);
        return Math.sqrt(xDist * xDist + yDist * yDist);
    }

    public static void translatePoint(double result[], double direction, double distance) {
        double changeX = 0.0;
        double changeY = 0.0;
    ...
    public static boolean anglesEqual(double angle1, double angle2) {
